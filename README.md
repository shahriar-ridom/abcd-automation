...
> Transform trending topics into engaging Facebook posts with the power of AI and real-time trend analysis
...
- 🔥 **Real-time Trend Analysis** - Automatically fetches trending topics from multiple sources
- 🤖 **AI-Powered Content Generation** - Uses advanced language models to create engaging posts
- 📊 **Multi-Source Data** - Combines insights from Hacker News, Reddit, and trending topics
...
4. **Ready to Share**: Get a polished post with hashtags and call-to-action
...
├── lib/
│   ├── functions/
│   │   ├── CreatePostAgent.ts    # Main AI agent
